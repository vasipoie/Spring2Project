...
//AbstractView 클래스를 상속받아 rendMergedOutputModel 메소드를 재정의하여 사용하면
...
public class NoticeDownloadView extends AbstractView{
	...
	public void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request
		...
		//ResponseEntity<byte[]> 이거랑 비슷한 방식이다
		...
		//사용하는 기기에 따라 인코딩하는 정보를 다르게 해줘야한다
		...
		//내가 사용하게 되는 브라우저의 버전이나 얻어온 header 정보들의 값에 따라
		//차이가 발생할 수 있습니다.
		...
		//try-with-resource
		//()안에 명시한 객체는 finally로 최종 열린 객체에 close를 처리하지 않아도
		//자동으로 close()가 이루어진다.
		try (
