...
$(function(){
	var idCheckFlag = false;		//중복 확인 flag(초기값 : 중복체크 안하는 false)
	...
	idCheckBtn.on('click', function(){
		...
		$.ajax({
			...
			success : function(res){
				...
				//EXIST, NOTEXIST에 따라서
				//"사용가능한 아이디 입니다" 또는 "이미 사용 중인 아이디입니다"를 출력
				console.log(res);
				
				if(res == "NOTEXIST"){	//아이디 사용 가능
					alert("사용 가능한 아이디입니다!");
					idCheckFlag = true;	//중복 확인 했다는 flag 설정 값
	...
	//상세주소까지 입력된 후 포커스가 전환됐을 때, 지도를 띄운다.
	...
	signupBtn.on('click', function(){
		...
		//중복확인 처리가 true일 때만 가입하기가 가능하도록 처리
