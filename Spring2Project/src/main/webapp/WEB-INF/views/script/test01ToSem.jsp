					...
					<div class="col-md-3">
						<div class="card">
							...
							<div class="card-footer">
								<a class="btn btn-primary" href="/testt/download.do?fileName=${imageFile}" download>다운로드</a>
							</div>					
						</div>
					</div>
				</c:forEach>
...
$(function(){
		...
		$.ajax({
			...
			success : function(res){
				...
				res.map(function(v,i){
					...
					html += "			<a class='btn btn-primary' href='/testt/download.do?fileName="+v+"'>다운로드</a>";
					html += "		</div>					";
					html += "	</div>";
					html += "</div>";
				});
	...
	//selectbox에서 선택된 경우에는 썸네일이 안만들어짐 -> 동적이라서
// 	$("img").on("click", function(){
// 		var fileName = $(this).data("filename");
// 		location.href = "/testt/thumbnail.do?fileName="+fileName;
// 	});
